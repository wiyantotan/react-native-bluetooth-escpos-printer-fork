...
type BluetoothTscPrinterType = {
  printLabel(options: number): Promise<any>;
};
...
const { BluetoothTscPrinter } = NativeModules;

export default BluetoothTscPrinter as BluetoothTscPrinterType;
