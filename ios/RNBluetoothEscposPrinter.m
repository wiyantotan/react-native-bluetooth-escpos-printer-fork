...
{
    NSDictionary *errorConnection = @{@"L": @1, @"M": @0, @"Q": @3, @"H": @2};
    NSDictionary *barcodeType = @{@"UPC_A": @65, @"UPC_E": @66, @"JAN13": @67, @"JAN8": @68, @"CODE39": @69, @"ITF": @70, @"CODABAR": @71, @"CODE93": @72, @"CODE128": @73};
    NSDictionary *rotation = @{@"OFF": @0, @"ON": @1};
    NSDictionary *align = @{@"LEFT": @0, @"CENTER": @1, @"RIGHT": @2};
    
    return @{ @"width58":[NSString stringWithFormat:@"%i", WIDTH_58],
              @"width80":[NSString stringWithFormat:@"%i", WIDTH_80],
              @"ERROR_CORRECTION":errorConnection,
